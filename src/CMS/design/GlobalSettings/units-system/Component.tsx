...
import { unitSymbols } from './symbols-map'

interface UnitsComponentProps extends SelectFieldClientProps {
  iconSize?: number
}

export const SystemOfUnitsComponent: React.FC<UnitsComponentProps> = (
  props,
) => {
  ...
  const modifiedField = {
    ...
    options: field.options?.map((option: Option) => {
      ...
      const Icon = unitSymbols[optionValue]
