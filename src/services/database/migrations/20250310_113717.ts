...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE IF NOT EXISTS "global_settings" (
  	...
  	"site_identity_global_unit" "enum_global_settings_site_identity_global_unit" DEFAULT 'm',
  	"site_identity_system_of_units_meta" jsonb,
  ...
  CREATE INDEX IF NOT EXISTS "redirects_rels_categories_id_idx" ON "redirects_rels" USING btree ("categories_id");
